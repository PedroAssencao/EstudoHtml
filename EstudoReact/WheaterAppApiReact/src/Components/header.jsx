    ...
    return (
        <div className='container-fluid p-2 mt-4 d-flex justify-content-between align-itemns-center'>
            ...
            <div className='p-0 my-auto' style={{ width: "16rem" }}>
                <input type="text" className="border-0 form-control" placeholder='Insira Sua Localização' aria-label="Default" aria-describedby="inputGroup-sizing-default" />
            </div>
            <div className='bg-info rounded-pill d-flex justify-content-center align-items-center my-auto' style={{ width: "3rem", height: "3rem" }}>
